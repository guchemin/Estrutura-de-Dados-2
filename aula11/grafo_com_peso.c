...
void inserir_aresta_adj(GrafoA* G, int a, int b, int peso){
...
void inserir_aresta_adj_bid(GrafoA* G, int a, int b, int peso){
    inserir_aresta_adj(G, a, b, peso);
    inserir_aresta_adj(G, b, a, peso);
}
...
void inserir_aresta_mat(GrafoM* G, int a, int b, int peso){
...
void inserir_aresta_mat_bid(GrafoM* G, int a, int b, int peso){
    inserir_aresta_mat(G, a, b, peso);
    inserir_aresta_mat(G, b, a, peso);
}
